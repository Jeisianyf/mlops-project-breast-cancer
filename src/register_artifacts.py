...
def register_model() -> None:
    ...
    # Get the experiment ID for the 'ml_breast_cancer_classification' experiment
    experiment_id = client.get_experiment_by_name("ml_breast_cancer_classification").experiment_id
